<template>
  <section class="px-4 w-full max-w-[480px] mx-auto dark:bg-gray-600 ">
    ...
    <div class="mb-4">
      <div
        class="bg-gradient-to-br from-green-500 to-green-600 dark:from-green-600 dark:to-green-700 rounded-2xl text-white shadow-lg p-4">
        ...
        <button
          ...
          :class="
            selectedStatus === status.value
              ...
              : 'responseTime text-gray-700 dark:text-gray-300 border-gray-300 dark:border-gray-600'
          ">
          {{ status.label }}
        </button>
      </div>
